...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Horizon Link Agency empowers African families with trusted study abroad and skilled migration pathways." },
      { name: "author", content: "Horizon Link Agency" },
      { property: "og:title", content: "Horizon Link Agency — Migration & Education" },
      { property: "og:description", content: "Trusted study abroad and skilled migration pathways for African families." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Horizon Link Agency — Migration & Education" },
      { name: "twitter:description", content: "Trusted study abroad and skilled migration pathways for African families." },
